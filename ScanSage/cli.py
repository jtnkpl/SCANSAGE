...
def parse_args():
    parser = argparse.ArgumentParser(description="Process ScanSage.")
    parser.add_argument(
        "-l",
        "--lang",
        nargs='+',
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Force ScanSage to recognize only subset of characters",
    )
    parser.add_argument(
        "--blocklist",
        type=str,
    ...
    parser.add_argument(
        ...
        type=list,
        default=None,
        help="Allow ScanSage to rotate each text box and return the one with the best confident score. Eligible values are 90, 180 and 270. For example, try [90, 180 ,270] for all possible text orientations.",
    )
    parser.add_argument(
        "--paragraph",
        type=bool,
...
def main():
    args = parse_args()
    reader = ScanSage.Reader(lang_list=args.lang,\
                            gpu=args.gpu,\
